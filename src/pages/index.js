        ...
        <>
            ...
            <Section title={SECTION_TITLE_ABOUT}>
                <Box>
                    <Text
                        ...
                        letterSpacing={1.75}
                    >
                        I am an enthusiastic Software Engineer. I like creating
                        new user-friendly web and mobile applications. I am also
                        very interested learning new things and get better and
                        better each day.
                    </Text>
                </Box>
            </Section>
            ...
            <Section title={SECTION_TITLE_HOBBIES}>
                <Text
                    ...
                    letterSpacing={1.75}
                >
                    Chess, self-development, start-up, technologies, reading,
                    programming, piano
                </Text>
            </Section>
